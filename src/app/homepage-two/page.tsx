...
export default function HomepageTwo() {
  return (
    <div className="min-h-screen">
      ...
      {/* TWO-PATH SECTION - New from Gigawatt */}
      <section className="px-6 py-24 bg-[#fafafa]">
        <div className="max-w-5xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12">
            <h2 className="font-montserrat text-sm font-medium tracking-[3px] uppercase text-[--ink] mb-3">
              Two Kinds of Leaders Navigate AI
            </h2>
            <p className="text-[15px] text-[#666]">Which one are you?</p>
          </div>

          {/* Two Cards */}
          <div className="grid md:grid-cols-2 gap-8">
            {/* Technical Leaders Card */}
            <Link 
              href="/work-with-me" 
              className="group relative bg-white border border-[#e5e5e5] rounded-sm p-8 cursor-pointer
            ...
            >
              ...
              <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#6b8294] opacity-0 group-hover:opacity-100 transition-opacity duration-[250ms]" />
              
              {/* Label */}
              <p className="font-montserrat text-[10px] font-semibold tracking-[2px] uppercase text-[#999] mb-4">
                For Technical Leaders
              </p>
              
              {/* Three-line headline */}
              <div className="mb-5 space-y-1">
                <p className="font-montserrat text-[17px] font-medium leading-relaxed text-[#333]">
                  You build the tech.
                </p>
                <p className="font-montserrat text-[17px] font-medium leading-relaxed text-[#333]">
              ...
              <p className="text-sm text-[#666] leading-relaxed mb-6">
                You&apos;re ahead on the technology. The bottleneck is people —
                your team, your customers, your board.
              </p>
              
              {/* CTA */}
              <span className="font-montserrat text-[11px] font-medium tracking-wide text-[#333]
                              inline-flex items-center gap-2 group-hover:gap-3 transition-all">
            ...
            >
              {/* Left accent - appears on hover */}
              <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#8a9474] opacity-0 group-hover:opacity-100 transition-opacity duration-[250ms]" />
              ...
              {/* Body */}
              <p className="text-sm text-[#666] leading-relaxed mb-6">
                You&apos;re in rooms where AI comes up. You want to lead those
                conversations, not defer to IT or delegate to your team.
              </p>
